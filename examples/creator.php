...
// Set up a new creator for given file (ensure write-access) with given map
$dbcc = new DBCCreator($file, $map);

// Adding a single record
$dbcc->add(1, 'John', 100, 1.80, 2, 0);

// Adding multiple records in one call
$dbcc->add(array(2, 'Tim', 1337, 1.80, 1, 0), array(3, 'Pete', -10, 1.55, 1, 2));
...
$dbcc->add(11, 'I am providing too many fields', 123, 1.20, 0, 0, 100, 200, 0, 'Hello');
// The following will append 0, 0, 0, 0 to the actual record
$dbcc->add(12, 'I am providing too little fields');
...
// Finalizing the DBC writes the actual file to disk (any attempts to add additional records from this point onwards will fail)
$dbcc->finalize();

// Load the DBC we just created with the map we previously set up
